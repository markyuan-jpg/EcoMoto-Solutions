...
const product = {
  ...
  'passenger-cruiser': {
    ...
    details: 'Passenger Cruiser. 2000W motor, 120km+ range. Comfortable seating.',
  ...
  'lfp-power': {
    ...
    details: 'LFP Power Series. 48-72V, 45-100Ah, 2000+ cycles. Smart BMS.',
...
export default function ProductPage({ params }: { params: { slug: string } }) {
  const p = product[params.slug as keyof typeof product];
