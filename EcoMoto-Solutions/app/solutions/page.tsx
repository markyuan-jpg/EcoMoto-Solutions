...
const applicationScenarios = [
  {
    ...
    longDescription: 'Our electric cargo tricycles are designed for last-mile delivery, postal services, and warehouse operations. With 800-2000W motor and 60-80km range, they can handle all-day deliveries on a single charge.',
    products: 'Urban Hauler, City Feeder',
    image: '/images/urban-logistics.webp',
  },
{
    title: 'Passenger Transport',
    description: 'Carry 2-3 passengers',
